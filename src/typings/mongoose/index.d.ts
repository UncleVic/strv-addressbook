...
declare module "mongoose" {
   ...
   *
   * T - type of objects properties
   * M - type of instance methods
   * S - type of statics methods
   */
  class Schema<T = any, M extends Partial<T> & Document = any, S = any> extends events.EventEmitter {
    /**
     * Schema constructor.
     ...
     */
    method<F extends keyof M>(method: F, fn: M[F]): this;
    method(methodObj: {
      [F in keyof M]: M[F]
    }): this;
  ...
  type SchemaDefinition<T = any> = {
    [P in keyof T]-?: SchemaTypeOpts<T[P]> | Schema | SchemaType;
  };
  ...
  class MongooseDocument {
     ...
     */
    populate<T = this>(callback: (err: any, res: this) => void): T;
    populate<T = this>(path: string, callback?: (err: any, res: this) => void): Promise<T>;
    populate<T = this>(path: string, names: string, callback?: (err: any, res: this) => void): Promise<T>;
    populate<T = this>(options: ModelPopulateOptions | ModelPopulateOptions[], callback?: (err: any, res: this) => void): Promise<T>;
  ...
  class DocumentQuery<T, DocType extends Document, QueryHelpers = {}> extends mquery {
    ...
    */
     ...
     */
    populate<T = this>(path: string | any, select?: string | any, model?: any, match?: any, options?: any): T;
    populate<T = this>(options: QueryPopulateOptions | QueryPopulateOptions[]): T;
  ...
  interface Model<T extends Document, QueryHelpers = {}, P = any> extends NodeJS.EventEmitter, ModelProperties {
    ...
    */
     ...
     */
    populate<N = any>(docs: T[], options: ModelPopulateOptions | ModelPopulateOptions[], callback?: (err: any, res: T[]) => void): Promise<N[]>;
    populate<N = any>(doc: T, options: ModelPopulateOptions | ModelPopulateOptions[], callback?: (err: any, res: T) => void): Promise<N>;
